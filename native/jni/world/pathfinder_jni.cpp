...
#define LOGE(...) std::cerr << "[PathfinderJNI][ERROR] " << __VA_ARGS__ << std::endl
#define LOGW(...) std::cerr << "[PathfinderJNI][WARN] " << __VA_ARGS__ << std::endl
#define LOGI(...) std::cout << "[PathfinderJNI][INFO] " << __VA_ARGS__ << std::endl
